...
A metodologia adotada foi dividida em duas etapas complementares. A primeira consistiu na validação lógica da arquitetura de software e dos algoritmos de controle em ambiente de simulação. A segunda concentrou-se na validação física do seguimento de linha utilizando sensores infravermelhos, controle PID embarcado e processamento local baseado em \textit{Edge Computing}.
